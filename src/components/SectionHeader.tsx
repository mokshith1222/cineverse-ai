...
export default function SectionHeader({ title, subtitle, viewAllTo, onViewAll, accent = 'cyan', icon, as = 'h2' }: Props) {
  const accentColor = {
    ...
    <div className="flex items-end justify-between mb-6">
      <div>
        <div className="flex items-center gap-3 mb-1">
          ...
          <Tag className={`text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r ${accentColor}`}>
            {title}
          </Tag>
        </div>
